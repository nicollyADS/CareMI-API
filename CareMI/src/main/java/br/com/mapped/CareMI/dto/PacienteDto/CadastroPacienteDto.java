...
@Schema(description = "Dados para o cadastro de um paciente")
public record CadastroPacienteDto(

        @Schema(description = "Nome completo do paciente", maxLength = 100, example = "João Silva")
        @NotBlank(message = "O nome não pode estar em branco")
        @Size(max = 100, message = "O nome deve ter no máximo 100 caracteres")
        String nome,

        @Schema(description = "Peso do paciente em kg", example = "75")
        @NotNull(message = "O peso não pode ser nulo")
        @Positive(message = "O peso deve ser um número positivo")
        Integer peso,

        @Schema(description = "Altura do paciente em cm", example = "180")
        ...
        @Schema(description = "Sexo biológico do paciente", example = "Masculino")
        @NotNull(message = "O sexo biológico não pode estar em branco")
        SexoBiologico sexoBiologico,

        @Schema(description = "ID do usuário associado ao paciente", example = "54321")
        @NotNull(message = "O id do usuario não pode estar em branco")
        Long idUsuario,

        @Schema(description = "Nome do paciente para a carteirinha", maxLength = 100, example = "João Silva")
        @NotBlank(message = "O nome não pode estar em branco")
        @Size(max = 100, message = "O nome deve ter no máximo 100 caracteres")
        String nomePaciente,
        ...
        @Schema(description = "Data de nascimento do paciente", example = "1990-04-15")
