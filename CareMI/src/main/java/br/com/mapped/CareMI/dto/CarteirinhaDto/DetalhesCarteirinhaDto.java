...
public record DetalhesCarteirinhaDto(Long id, String nome, String planoSaude, Long cns, String empresa, String carencia, String acomodacao, LocalDate dataNascimento) {
