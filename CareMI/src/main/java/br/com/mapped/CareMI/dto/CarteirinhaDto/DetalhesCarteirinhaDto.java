...
public record DetalhesCarteirinhaDto(Long id, String nome, String planoSaude, int cns, String empresa, String carencia, String acomodacao, LocalDate dataNascimento) {
